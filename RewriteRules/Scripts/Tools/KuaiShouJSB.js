...
class _0x9d8dda {
  ...
  async ["luckdrawTasksReward"](T) {
    ...
    a['data']['success'] == true ? console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励获得" + a["data"]["popUp"]["taskRewardName"]) : console["log"]("账号[" + this["name"] + "]领取抽奖任务[" + T["taskTitle"] + "]奖励失败：" + a['data']["msg"]);
  }
